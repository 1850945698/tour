		...
		<div class="mybody">
		    <div class="header">
			    ...
			    <div class="right">
			    	...
			    	<div class="dlzc">
			    		请&nbsp;<a href="login.jsp" style="text-decoration: none;">登录</a>&nbsp;或&nbsp;<a href="register.jsp" style="text-decoration: none;">注册</a>
			    	</div>
			    	<div class="inss">
			    		<div class="ssk">
	        			...
	        			<ul class="king lf">
	        				<li class="list_bg" style="position: absolute; top: 42px; left: -20px;">
	        					<a href="##" class="city_name">
	        					    ...
	        					    <img src="images/chengchuanwan.jpg" width="486px" height="376px" style="display: inline;" />
	        				    </a>
	        			...
	        			<ul class="kind lf">
	        				<li class="list_small" style="position: absolute; left: 485px;">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/daoyuwan.jpg" width="224px"; height="160px"; style="display: inline;">
	        					</a>
	        				...
	        				<li class="list_small" style="position: absolute; left: 485px; top: 260px;">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/shumeidao.jpg" width="224px"; height="160px"; style="display: inline;">
	        					</a>
	        			...
	        			<ul class="kind lf">
	        				<li class="list_small" style="position: absolute; left: 728px;">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/xidao.jpg" width="224px"; height="160px"; style="display: inline;">
	        					</a>
	        				...
	        				<li class="list_small" style="position: absolute; left: 728px; top: 260px;">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/longriddao.jpg" width="224px"; height="160px"; style="display: inline;">
	        					</a>
	        			...
	        			<ul class="kind lf">
	        				<li class="list_small" style="position: absolute; left: 971px;">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/xnnydao.jpg" width="224px"; height="160px"; style="display: inline;">
	        					</a>
	        				...
	        				<li class="list_small" style="position: absolute; left: 971px; top: 260px;">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/hmeddao.jpg" width="224px"; height="160px"; style="display: inline;">
	        					</a>
	        			...
	        			<ul class="king lf">
	        				<li class="list_bg" style="position: absolute; top: 42px; left: -20px;">
	        					<a href="##" class="city_name">
	        					    ...
	        					    <img src="images/wlwtdc.jpg" width="486px" height="376px" style="display: inline;" />
	        				    </a>
	        			...
	        			<ul class="kind lf">
	        				<li class="list_small" style="position: absolute; left: 485px; top: 42px;">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/btlzj.jpg" width="224px"; height="160px"; style="display: inline;">
	        					</a>
	        				...
	        				<li class="list_small" style="position: absolute; left: 485px; top: 260px;">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/xyd.jpg" width="224px"; height="160px"; style="display: inline;">
	        					</a>
	        			...
	        			<ul class="kind lf">
	        				<li class="list_small" style="position: absolute; left: 728px; top: 41px;">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/caihondun.jpg" width="224px"; height="160px"; style="display: inline;">
	        					</a>
	        				...
	        				<li class="list_small" style="position: absolute; left: 728px; top: 260px;">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/fjdhds.jpg" width="224px"; height="160px"; style="display: inline;">
	        					</a>
	        			...
	        			<ul class="kind lf">
	        				<li class="list_small" style="position: absolute; left: 971px; top: 41px;">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/hxstlngy.jpg" width="224px"; height="160px"; style="display: inline;">
	        					</a>
	        				...
	        				<li class="list_small" style="position: absolute; left: 971px; top: 260px;">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/amyrmt.jpg" width="224px"; height="160px"; style="display: inline;">
	        					</a>
	        			...
	        			<ul class="king lf">
	        				<li class="list_bg" style="position: absolute; top: 42px; left: -20px;">
	        					<a href="##" class="city_name">
	        					    ...
	        					    <img src="images/daxidi.jpg" width="486px" height="376px" style="display: inline;" />
	        				    </a>
	        			...
	        			<ul class="kind lf">
	        				<li class="list_small" style="position: absolute; left: 485px; top: 42px;">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/balidao.jpg" width="224px"; height="160px"; style="display: inline;">
	        					</a>
	        				...
	        				<li class="list_small" style="position: absolute; left: 485px; top: 260px;">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/yeke.jpg" width="224px"; height="160px"; style="display: inline;">
	        					</a>
	        			...
	        			<ul class="kind lf">
	        				<li class="list_small" style="position: absolute; left: 728px; top: 41px;">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/weiyena.jpg" width="224px"; height="160px"; style="display: inline;">
	        					</a>
	        				...
	        				<li class="list_small" style="position: absolute; left: 728px; top: 260px;">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/pujidao.jpg" width="224px"; height="160px"; style="display: inline;">
	        					</a>
	        			...
	        			<ul class="kind lf">
	        				<li class="list_small" style="position: absolute; left: 971px; top: 41px;">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/huanghouzhneg.jpg" width="224px"; height="160px"; style="display: inline;">
	        					</a>
	        				...
	        				<li class="list_small" style="position: absolute; left: 971px; top: 260px;">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/mlqs.jpg" width="224px"; height="160px"; style="display: inline;">
	        					</a>
	        			...
	        			<ul class="king lf">
	        				<li class="list_bg" style="position: absolute; top: 42px; left: -20px;">
	        					<a href="##" class="city_name">
	        					    ...
	        					    <img src="images/rbzgf.jpg" width="486px" height="376px" style="display: inline;" />
	        				    </a>
	        			...
	        			<ul class="kind lf">
	        				<li class="list_small" style="position: absolute; left: 485px; top: 42px;">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/sqdhbxs.jpg" width="224px"; height="160px"; style="display: inline;">
	        					</a>
	        				...
	        				<li class="list_small" style="position: absolute; left: 485px; top: 260px;">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/hhytzdds.jpg" width="224px"; height="160px"; style="display: inline;">
	        					</a>
	        			...
	        			<ul class="kind lf">
	        				<li class="list_small" style="position: absolute; left: 728px; top: 41px;">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/sszw.jpg" width="224px"; height="160px"; style="display: inline;">
	        					</a>
	        				...
	        				<li class="list_small" style="position: absolute; left: 728px; top: 260px;">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/xzzszf.jpg" width="224px"; height="160px"; style="display: inline;">
	        					</a>
	        			...
	        			<ul class="kind lf">
	        				<li class="list_small" style="position: absolute; left: 971px; top: 41px;">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/azzxdsm.jpg" width="224px"; height="160px"; style="display: inline;">
	        					</a>
	        				...
	        				<li class="list_small" style="position: absolute; left: 971px; top: 260px;">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/xgly.jpg" width="224px"; height="160px"; style="display: inline;">
	        					</a>
	        			...
	        			<ul class="list">
	        				<li class="around_item">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/qxs.jpg" width="224px"; height="170px">
	        					</a>
	        				</li>
	        				<li class="around_item">
	        					<a href="##" class="city_name">
	        						<span class="name">中山路</span>
	        						<img src="images/zsl.jpg" width="224px"; height="170px">
	        					</a>
	        				</li>
	        				<li class="around_item">
	        					<a href="##" class="city_name">
	        						<span class="name">广西民族博物馆</span>
	        						<img src="images/gxmzbwg.jpg" width="224px"; height="170px">
	        					</a>
	        				</li>
	        				<li class="around_item">
	        					<a href="##" class="city_name">
	        						<span class="name">南湖公园</span>
	        						<img src="images/nhgy.jpg" width="224px"; height="170px">
	        					</a>
	        				</li>
	        				<li class="around_item">
	        					<a href="##" class="city_name">
	        						<span class="name">万象城</span>
	        						<img src="images/wxc.jpg" width="224px"; height="170px">
	        					</a>
	        				</li>
	        			</ul>
	        		</div>
	        			...
	        			<ul class="list">
	        				<li class="around_item">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/lj.jpg" width="224px"; height="170px">
	        					</a>
	        				</li>
	        				<li class="around_item">
	        					<a href="##" class="city_name">
	        						<span class="name">两江四湖</span>
	        						<img src="images/ljsh.jpg" width="224px"; height="170px">
	        					</a>
	        				</li>
	        				<li class="around_item">
	        					<a href="##" class="city_name">
	        						<span class="name">象山景区</span>
	        						<img src="images/xsjq.jpg" width="224px"; height="170px">
	        					</a>
	        				</li>
	        				<li class="around_item">
	        					<a href="##" class="city_name">
	        						<span class="name">遇龙河</span>
	        						<img src="images/ylh.jpg" width="224px"; height="170px">
	        					</a>
	        				</li>
	        				<li class="around_item">
	        					<a href="##" class="city_name">
	        						<span class="name">西街</span>
	        						<img src="images/xj.jpg" width="224px"; height="170px">
	        					</a>
	        				</li>
	        			</ul>
	        		</div>
	        			...
	        			<ul class="list">
	        				<li class="around_item">
	        					<a href="##" class="city_name">
	        						...
	        						<img src="images/bhlj.jpg" width="224px"; height="170px">
	        					</a>
	        				</li>
	        				<li class="around_item">
	        					<a href="##" class="city_name">
	        						<span class="name">银滩</span>
	        						<img src="images/bhyt.jpg" width="224px"; height="170px">
	        					</a>
	        				</li>
	        				<li class="around_item">
	        					<a href="##" class="city_name">
	        						<span class="name">涠洲岛</span>
	        						<img src="images/wzd.jpg" width="224px"; height="170px">
	        					</a>
	        				</li>
	        				<li class="around_item">
	        					<a href="##" class="city_name">
	        						<span class="name">北海公园</span>
	        						<img src="images/bhgy.jpg" width="224px"; height="170px">
	        					</a>
	        				</li>
	        				<li class="around_item">
	        					<a href="##" class="city_name">
	        						<span class="name">天主教堂</span>
	        						<img src="images/tzjt.jpg" width="224px"; height="170px">
	        					</a>
	        				</li>
	        			</ul>
	        		</div>
